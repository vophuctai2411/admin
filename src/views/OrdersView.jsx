...
class OrdersView extends Component {
  ...
  getOrders = (object) => {
    ...
    const totals = document
      .getElementsByName("order-total")[0]
      .value.split(",");
    const queryObj = {
      ...
      StatusID:
        0 === this.state.selectedStatus ? "" : this.state.selectedStatus,
    ...
    // window
    //   .OrderAPIsService_Search(queryObj)
    //   .then((result) =>
    //     this.setState({
  ...
  render() {
    ...
    const orderID = this.state.selected[0]
