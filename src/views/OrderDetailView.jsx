      ...
      .then((result) => {
        switch (result.statusCode) {
          ...
          case 200:
            notify(
              result.json.error.message,
              "Update Order Status successfull",
              "success"
            );
            break;
          default:
      ...
      <div className={classes.root}>
        <div className={classes.row}>
          <Typography variant="h4">
            Order Details and Change Order Status
          </Typography>
        </div>
              ...
              <Grid container spacing={3} style={{ marginTop: 8 }}>
                ...
                <Grid item xs={12} sm={4} md={4}>
                  <TextField
                    ...
                    label="District name"
                    size="small"
                    value={this.state.order.district}
                  />
                </Grid>
                <Grid item xs={12} sm={4} md={4}>
                  <TextField
                    ...
                    label="Commune name"
                    size="small"
                    value={this.state.order.commune}
                  />
                </Grid>
              ...
              <Grid container spacing={3} style={{ marginTop: 8 }}>
                <Grid item xs={12} sm={6} md={3}>
                  <TextField
                    ...
                    label="Subtotal"
                    size="small"
                    value={this.state.order.cart.subtotal}
                  />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <TextField
                    ...
                    label="Delivery"
                    size="small"
                    value={this.state.order.cart.delivery}
                  />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <TextField
                    ...
                    label="Discount"
                    size="small"
                    value={this.state.order.cart.discount}
                  />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <TextField
                    ...
                    label="Total"
                    size="small"
                    value={this.state.order.cart.total}
                  />
                </Grid>
              </Grid>
            </CardContent>
