            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6} md={8}>
                <TextField
                  ...
                  label="Title"
                  size="small"
                  value={contentContext.introSection.title}
                  onChange={(e) => {
                    contentContext.updateIntro({
                ...
                <TextField
                  ...
                  rows={5}
                  rowsMax={16}
                  value={contentContext.introSection.description}
                  onChange={(e) => {
                    contentContext.updateIntro({
...
export default withStyles(styles, { withTheme: true })(IntroSection);
